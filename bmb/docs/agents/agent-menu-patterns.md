...
menu:
  ...
  - trigger: brainstorm
    workflow: '{project-root}/./core/workflows/brainstorming/workflow.yaml'
...
# GOOD - Portable paths
workflow: "{project-root}/./bmm/workflows/prd/workflow.yaml"
exec: "{project-root}/./core/tasks/validate.xml"
...
menu:
  - trigger: workflow-init
    workflow: '{project-root}/./bmm/workflows/workflow-status/init/workflow.yaml'
