...
- installed_path = `{project-root}/./bmm/workflows/2-plan-workflows/prd`
...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with the current content
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with the current content
