...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with validation issues
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with validation context
