...
<critical>You MUST have already loaded and processed: {project-root}/./bmb/workflows/edit-module/workflow.yaml</critical>
...
<ask>What is the path to the module you want to edit? (provide path to module directory like ./bmm/ or src/modules/bmm/)</ask>
...
- Show how to reference workflows properly: {project-root}/./{{module}}/workflows/{{workflow}}/workflow.yaml
