...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with the current responsive/accessibility content
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with the current responsive/accessibility strategy
