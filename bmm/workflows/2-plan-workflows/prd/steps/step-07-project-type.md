...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with the current project-type content
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with the current project-type requirements
...
- Load `{project-root}/./bmm/workflows/2-plan-workflows/prd/steps/step-08-scoping.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/./bmm/workflows/2-plan-workflows/prd/steps/step-08-scoping.md` to define project scope.
