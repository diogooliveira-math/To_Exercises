...
menu:
  - trigger: command-name
    workflow: '{project-root}/./SOURCE_MODULE/workflows/path/workflow.yaml'
    workflow-install: '{project-root}/./THIS_MODULE/workflows/vendored/workflow.yaml'
...
data_path:
  result: '{project-root}/./module-code/data'
```
