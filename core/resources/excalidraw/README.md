...
helpers: '{project-root}/./core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/./core/resources/excalidraw/validate-json-instructions.md'
```
