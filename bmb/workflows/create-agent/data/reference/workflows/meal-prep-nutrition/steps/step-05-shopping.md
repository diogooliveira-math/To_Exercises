...
# Path Definitions
workflow_path: '{project-root}/./bmb/reference/workflows/meal-prep-nutrition'
...
- IF A: Execute `{project-root}/./core/tasks/advanced-elicitation.xml`
- IF P: Execute `{project-root}/./core/workflows/party-mode/workflow.md`
