...
agent:
  metadata:
    id: './{module-code}/agents/{agent-name}.md'
    name: 'Persona Name'
  ...
  menu:
    - trigger: workflow-action
      workflow: '{project-root}/./{module-code}/workflows/{workflow-name}/workflow.yaml'
      description: 'Execute module workflow'

    - trigger: another-workflow
      workflow: '{project-root}/./core/workflows/{workflow-name}/workflow.yaml'
      description: 'Execute core workflow'

    - trigger: task-action
      exec: '{project-root}/./{module-code}/tasks/{task-name}.xml'
      description: 'Execute module task'

    - trigger: cross-module
      workflow: '{project-root}/./other-module/workflows/{workflow-name}/workflow.yaml'
      description: 'Execute workflow from another module'

    - trigger: with-template
      exec: '{project-root}/./core/tasks/create-doc.xml'
      tmpl: '{project-root}/./{module-code}/templates/{template-name}.md'
      description: 'Create document from template'

    - trigger: with-data
      exec: '{project-root}/./{module-code}/tasks/{task-name}.xml'
      data: '{project-root}/./_cfg/agent-manifest.csv'
...
- **id**: Path with `.` variable (resolved at install time)
...
menu:
  - trigger: create-prd
    workflow: '{project-root}/./bmm/workflows/prd/workflow.yaml'
...
menu:
  - trigger: validate
    exec: '{project-root}/./core/tasks/validate-workflow.xml'
...
menu:
  - trigger: create-brief
    exec: '{project-root}/./core/tasks/create-doc.xml'
    tmpl: '{project-root}/./bmm/templates/brief.md'
...
menu:
  - trigger: team-standup
    exec: '{project-root}/./bmm/tasks/standup.xml'
    data: '{project-root}/./_cfg/agent-manifest.csv'
...
- `.` - BMAD installation folder (usually `.bmad`)
...
```xml
<step n="2">Load and read {project-root}/./{module}/config.yaml...</step>
```
...
menu:
  - trigger: init
    workflow: '{project-root}/./bmm/workflows/workflow-init/workflow.yaml'
    description: 'Initialize workflow path (START HERE)'

  - trigger: status
    workflow: '{project-root}/./bmm/workflows/workflow-status/workflow.yaml'
    description: 'Check current workflow status'

  - trigger: next-step
    workflow: '{project-root}/./bmm/workflows/next-step/workflow.yaml'
...
menu:
  # Phase 1: Analysis
  - trigger: brainstorm
    workflow: '{project-root}/./bmm/workflows/1-analysis/brainstorm/workflow.yaml'
    description: 'Guided brainstorming session'

  - trigger: research
    workflow: '{project-root}/./bmm/workflows/1-analysis/research/workflow.yaml'
    description: 'Market and technical research'

  # Phase 2: Planning
  - trigger: prd
    workflow: '{project-root}/./bmm/workflows/2-planning/prd/workflow.yaml'
    description: 'Create PRD'

  - trigger: architecture
    workflow: '{project-root}/./bmm/workflows/2-planning/architecture/workflow.yaml'
...
menu:
  - trigger: party-mode
    workflow: '{project-root}/./core/workflows/party-mode/workflow.yaml'
    description: 'Bring all agents together'

  - trigger: brainstorm
    workflow: '{project-root}/./cis/workflows/brainstorming/workflow.yaml'
    description: 'Use CIS brainstorming techniques'
```

## Best Practices

1. **Use . paths** - Portable across installations
...
menu:
  - trigger: start
    workflow: '{project-root}/./{module}/workflows/init/workflow.yaml'
...
menu:
  - trigger: status
    workflow: '{project-root}/./{module}/workflows/status/workflow.yaml'
...
| ------------- | -------------------------------- | ------------------------------- |
| Location      | `./{module}/agents/` | `./custom/agents/`  |
...
- [ ] id uses `./{module}/agents/{name}.md`
- [ ] All workflow paths use `{project-root}/./` prefix
- [ ] No hardcoded paths
