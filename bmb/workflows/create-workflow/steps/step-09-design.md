...
- `{project-root}/./bmb/docs/workflows/step-template.md` - Step file structure
- `{project-root}/./bmb/docs/workflows/workflow-template.md` - Workflow configuration
- `{project-root}/./bmb/docs/workflows/architecture.md` - Architecture principles
- `{project-root}/./bmb/reference/workflows/meal-prep-nutrition/workflow.md` - Complete example
...
```
Read: {project-root}/./bmb/docs/workflows/step-template.md
```
