...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with the current core experience content
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with the current core experience definition
