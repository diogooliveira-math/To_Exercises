...
- Example workflow: `{project-root}/./bmb/reference/workflows/meal-prep-nutrition/workflow.md`
- Step examples from same workflow's steps folder
- Architecture guide: `{project-root}/./bmb/docs/workflows/architecture.md`
