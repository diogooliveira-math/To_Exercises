...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with specific decision categories
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with architectural decisions context
