...
- Agent manifest CSV is available at `{project-root}/./_cfg/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{project-root}/./_cfg/agent-manifest.csv`
