...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with current starter analysis
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with starter evaluation context
