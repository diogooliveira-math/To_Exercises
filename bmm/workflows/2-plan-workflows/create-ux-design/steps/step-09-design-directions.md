...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with the current design direction content
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with the current design direction
