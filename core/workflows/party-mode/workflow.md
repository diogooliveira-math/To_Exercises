...
Load config from `{project-root}/./bmm/config.yaml` and resolve:

- `project_name`, `output_folder`, `user_name`
- `communication_language`, `document_output_language`, `user_skill_level`
- `date`, `current_year`, `current_month` as system-generated values
- Agent manifest path: `{project-root}/./_cfg/agent-manifest.csv`

### Paths

- `installed_path` = `{project-root}/./core/workflows/party-mode`
- `agent_manifest_path` = `{project-root}/./_cfg/agent-manifest.csv`
