...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with the current context analysis
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with the current project context
