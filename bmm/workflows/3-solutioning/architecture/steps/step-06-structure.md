...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with current project structure
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with project structure context
