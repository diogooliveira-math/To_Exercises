...
```xml
<agent id="./cis/agents/storyteller.md" name="Sophia" title="Master Storyteller" icon="📖">
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*story" exec="{project-root}/./cis/workflows/storytelling/workflow.yaml">Craft compelling narrative using proven frameworks</item>
