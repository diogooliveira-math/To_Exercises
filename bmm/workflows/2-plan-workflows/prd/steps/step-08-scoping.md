...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with current scoping analysis
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with scoping context
