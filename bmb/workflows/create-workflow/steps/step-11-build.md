...
# Path Definitions
workflow_path: '{project-root}/./bmb/workflows/create-workflow'
...
# Task References
advancedElicitationTask: '{project-root}/./core/tasks/advanced-elicitation.xml'
partyModeWorkflow: '{project-root}/./core/workflows/party-mode/workflow.md'

# Template References
workflowTemplate: '{project-root}/./bmb/docs/workflows/workflow-template.md'
stepTemplate: '{project-root}/./bmb/docs/workflows/step-template.md'
...
- When building each step file, you must follow template `{project-root}/./bmb/docs/workflows/step-template.md`
- When building the main workflow.md file, you must follow template `{project-root}/./bmb/docs/workflows/workflow-template.md`
- Example step files from {project-root}/./bmb/reference/workflows/meal-prep-nutrition/workflow.md for patterns
...
For bmb module, this will be: `./custom/src/workflows/{workflow_name}/`
...
- Configure all path variables ({project-root}, ., {workflow_path})
