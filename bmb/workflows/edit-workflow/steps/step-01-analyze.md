...
# Path Definitions
workflow_path: '{project-root}/./bmb/workflows/edit-workflow'
...
- `{project-root}/./bmb/docs/workflows/architecture.md`
- `{project-root}/./bmb/docs/workflows/step-template.md`
- `{project-root}/./bmb/docs/workflows/workflow-template.md`
