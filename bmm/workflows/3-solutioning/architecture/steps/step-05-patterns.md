...
- Execute {project-root}/./core/tasks/advanced-elicitation.xml with current patterns
...
- Execute {project-root}/./core/workflows/party-mode/workflow.md with implementation patterns context
